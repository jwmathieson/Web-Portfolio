...
const galleryInfo = [
    ...
    {src:"images/FunFacts/Glorbal_1.png",name:"Hi",description:"Worms",type:"image"},
    {src:"images/FunFacts/Glorbal_2.png",name:"Words",description:"Test Description 2",type:"image"},
    {src:"images/FunFacts/Glorbal_3.png",name:"Awesome Words",description:"Test Description 5",type:"image"},
    {src:"images/FunFacts/Glorbal_4.png",name:"Cool Words",description:"Test Description 3",type:"image"},
    {src:"images/FunFacts/Glorbal_5.png",name:"Awesome House",description:"Test Description 2",type:"image"},
    {src:"images/FunFacts/Glorbal_2.png",name:"Words",description:"Test Description 2",type:"image"},
    {src:"images/FunFacts/Glorbal_3.png",name:"Awesome Words",description:"Test Description 5",type:"image"},
    {src:"images/FunFacts/Glorbal_4.png",name:"Cool Words",description:"Test Description 3",type:"image"},
    {src:"images/ImageGallery/Videos/TestVideo.mp4",name:"Awesome House",description:"Test Description 2",type:"video"},
...
function imageGalleryPositionalElements(){
    ...
    for (i in galleryInfo){
        ...
        newPositionalSlot.addEventListener("click",function(){

            updateImageGallery("SetPosition",i);
