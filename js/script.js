...
window.onload=function(){
    ...
    function updateHeroBackground(){
        ...
        if (hero){
            ...
            userData["RepeatingBackgroundPos"] ++;

            hero.style.backgroundPosition = userData["RepeatingBackgroundPos"] + "px " + userData["RepeatingBackgroundPos"] + "px";
...
const galleryInfo = [
    ...
    {src:"images/ImageGallery/swordRender.gif",name:"3D Model: Sword",description:"Worms",type:"image"},
    {src:"images/ImageGallery/magicSwordRender.gif",name:"3D Model: 'Frostmourne'",description:"Test Description 2",type:"image"},
    {src:"images/ImageGallery/spearRender.gif",name:"3D Model: Spear",description:"Test Description 5",type:"image"},
    {src:"images/ImageGallery/daggerRender.gif",name:"3D Model: Dagger",description:"Test Description 3",type:"image"},
    {src:"images/ImageGallery/hammerRender.gif",name:"3D Model: Hammer",description:"Test Description 2",type:"image"},
    {src:"images/ImageGallery/basiliskRender.jpg",name:"3D Model: The Basilisk",description:"Test Description 2",type:"image"},
    {src:"images/ImageGallery/rootkeeperFront.jpg",name:"3D Model: Rootkeeper (1)",description:"Test Description 5",type:"image"},
    {src:"images/ImageGallery/rootkeeperBack.jpg",name:"3D Model: Rootkeeper (2)",description:"Test Description 3",type:"image"},
